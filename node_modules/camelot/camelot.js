...
fs.mkdir(location, 0777, function(error) {
	logger.error(error);
});
            ...
            function () {
              ...
              for ( var option in this.opts) {
                switch (option) {
                  ...
                  default:
                    self.arguments.push("--" + option);
                   	if (typeof self.opts[option] !== 'boolean') {
                   		self.arguments.push(self.opts[option]);
                   	} 
                    break;
                }
              ...
              fswebcam = spawn('fswebcam', self.arguments);
              //logger.info(self.arguments);
              
              // monitor fswebcam output
...
Camelot.prototype.stop = function() {
	logger.error("Killing fsWebcam");
	fswebcam && fswebcam.kill("SIGHUP");
